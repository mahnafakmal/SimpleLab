...
<body>
    <div class="card">
        ...
        <form action="{{ route('register.dosen.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    ...
                    <button type="button" onclick="togglePasswordVisibility('password', this)" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); width: 34px; height: 34px; background: none; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; padding: 0; line-height: 0; color: #64748b;">
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    <input id="password_confirmation" type="password" name="password_confirmation" class="form-input" required style="padding-right: 40px;">
                    <button type="button" onclick="togglePasswordVisibility('password_confirmation', this)" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); width: 34px; height: 34px; background: none; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; padding: 0; line-height: 0; color: #64748b;">
                        <i data-lucide="eye" style="width: 20px; height: 20px;"></i>
                    </button>
                </div>
            </div>
        ...
        <div style="text-align:center;margin-top:1rem;color:#64748b;font-size:.9rem">
            Sudah punya akun? <a href="{{ route('login') }}" style="color:#1e40af;font-weight:600">Masuk</a>
        </div>
    </div>
