...
<section class="bg-white dark:bg-[#161615] p-4 rounded-lg shadow-md">
    ...
    <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mb-4">Lihat riwayat peminjaman barang dan ruangan.</p>
    <div class="flex gap-3">
        <a href="{{ route('admin.laporan.peminjaman') }}" class="px-4 py-2 bg-blue-600 text-white rounded">Laporan Peminjaman Barang</a>
        <a href="{{ route('admin.laporan.ruangan') }}" class="px-4 py-2 bg-green-600 text-white rounded">Laporan Peminjaman Ruangan</a>
    </div>
</section>
@else
<section class="bg-white dark:bg-[#161615] p-4 rounded-lg shadow-md">
