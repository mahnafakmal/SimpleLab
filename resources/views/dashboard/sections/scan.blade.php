<div id="scan" class="tab-content">
    <div class="card form-card">
        <h3>Daftarkan Barang dengan Scan RFID</h3>
    ...
    <div class="note-box" style="margin-top:1rem;">
        <p>Semua pendaftaran barang dan tag RFID sekarang dilakukan di tab ini. Untuk peminjaman gunakan tab <strong>Peminjaman</strong>, dan untuk update masuk/keluar gunakan tab <strong>Aktifitas</strong>.</p>
    </div>
</div>
